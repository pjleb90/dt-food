...
const Menu = () => {
    ...
    return (
        <div>
            ...
            <section className="bg-white dark:bg-black bg-cover">
                <div className="py-8 px-4 mx-auto max-w-screen-xl md:py-10 md:px-6">
                    <div className="max-w-screen-md">
                        ...
                        <p className="mb-8 font-bold text-red-700 dark:text-white sm:text-xl md:text-2xl text-center md:text-left">
            ...
            {/* menu navigation */}
            <nav className="text-center text-xl p-2 flex font-bold bg-white dark:bg-black bg-cover md:px-36">
                <a href="#plates" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow underline">Plates</a>
                <a href="#combos" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow underline">Combos</a>
                <a href="#wraps" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow underline">Wraps</a>
                <a href="#salads" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow underline">Salads</a>
                <a href="#apps" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow  hidden md:inline underline">Appetizers & Sides</a>
                <a href="#apps" className="text-black dark:text-white  hover:text-red-700 mx-2 flex-grow md:hidden underline">Apps</a>
            </nav>
