        ...
        <div>
            <section className="bg-white dark:bg-black">
                <div className="py-8 px-4 mx-auto max-w-screen-2xl text-center lg:py-12 md:px-2">
                    ...
                    <p className="mb-8 text-lg md:text-xl font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-white">A fast casual Middle Eastern/Mediterranean restaurant specializing in providing delicious shawarma at a price that doesn&#39;t break the bank!</p>
