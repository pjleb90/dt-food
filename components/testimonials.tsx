            ...
            <section className="bg-white dark:bg-black">
                <div className="py-6 px-4 mx-auto max-w-screen-2xl text-center lg:py-8 lg:px-6">
                    <div className="mx-auto max-w-screen-xl">
                        ...
                        <p className="mb-8 font-bold text-gray-500 lg:mb-16 sm:text-xl dark:text-white">Don&#39;t just take it from us, here from our customers why we&#39;re the right choice for you.</p>
                    </div>
