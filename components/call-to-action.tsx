    ...
    return (
        <div className="w-full p-4 text-center bg-white rounded-lg shadow sm:p-8 dark:bg-black">
            ...
            <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                ...
                <a href="https://www.skipthedishes.com/double-taste-shawarma-northfield-dr" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-2xl md:rounded-lg inline-flex items-center justify-center px-4 py-2.5 border dark:bg-black dark:hover:bg-black dark:border-gray-600 dark:hover:outline-double dark:hover:border-red-700 dark:focus:ring-gray-700">
                ...
                <a href="https://www.doordash.com/store/double-taste-shawarma-waterloo-24361580/?event_type=autocomplete&pickup=false" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-2xl md:rounded-lg inline-flex items-center justify-center px-4 py-2.5 border dark:bg-black dark:hover:bg-black dark:border-gray-600 dark:hover:outline-double dark:hover:border-red-700 dark:focus:ring-gray-700">
